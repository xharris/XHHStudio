...
def runGame():
    ...
    if temp_path != None:
        ...
        if OS == 'windows':
            ...
            print 'cd '+new_path+' && open -n -a '+os.getcwd()+slash+'DATA'+slash+'love'+slash+'love.app "'+os.path.basename(temp_path)+'"'
            result = os.system('cd '+new_path+' && open -n -a '+os.getcwd()+slash+'DATA'+slash+'love'+slash+'love.app "'+os.path.basename(temp_path)+'"')
