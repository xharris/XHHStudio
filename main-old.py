...
#
import pyglet, math, random, gc, os, sys, ConfigParser, subprocess, threading, Queue, time, shutil, wx, pickle, json, ast, ntpath, inspect, zipfile, tempfile
...
def manageGUI():
    global mouse,mouse_rel,sel_img,sel_spr,camera,camera_text,entity_hover_txt,edit_entity,sel,moving,sel_pressed,sel_img_index,sel_img_ani,sel_img_angle,runonce_timer
...
def buildGame(platform):
    ...
    if temp_path != None:
        ...
        if platform == 'WINDOWS':
            ...
            threadFunc(makeLove,build_path)
            ...
            subprocess.Popen('explorer '+build_path)
